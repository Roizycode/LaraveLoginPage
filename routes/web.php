...
Route::post('/login', [LoginController::class, 'handleEmailSubmission'])->name('login.email');
Route::get('/login/password', [LoginController::class, 'showPasswordForm'])->name('login.password');
Route::post('/login/password', [LoginController::class, 'login'])->name('login.password.submit');
Route::post('/login/send-code', [LoginController::class, 'sendEmailCode'])->name('login.send.code');
Route::get('/login/verify-code', [LoginController::class, 'showVerifyCodeForm'])->name('login.verify.code');
Route::post('/login/verify-code', [LoginController::class, 'verifyEmailCode'])->name('login.verify.code.submit');
